...
=======
import r2_facial_recognition.client.rotation as rotate
from r2_facial_recognition.client.config import DEFAULT_LOCAL, DEFAULT_CACHE, \
    DEFAULT_CACHE_LOCATION, DEFAULT_PATH, DEFAULT_SCALE_FACTOR, DEFAULT_HOST, \
    DEFAULT_PORT, DEFAULT_DEVICE, DEFAULT_TIMEOUT, DEFAULT_CHECKIN_RATE, \
    TEXT_ENCODING, DEFAULT_UNKNOWN_FACE_ID, LOG_LEVEL, LOG_FILE
from r2_facial_recognition.client.camera import Camera
from r2_facial_recognition.client.local_recognition import check_faces as local_check_faces, \
    load_images as local_load_images, check_and_add as local_check_and_add
>>>>>>> 66abcaf49884657d0650a086b9381bceb1102fd6
...
=======
        ...
        def process_frame(i):
            ...
            workers.append(threading.Thread(target=analyze, args=(i,), daemon=True)) # Spawn thread
            # logger.info(f'\nTaking pic #{i+1}.\n')
>>>>>>> 66abcaf49884657d0650a086b9381bceb1102fd6

            workers[i].start() # Start thread
...
=======
            ...
            print('C1C0 TURN LEFT')
            rotate.send_msg(rotate.format_msg(30, 1, 0))
            time.sleep(rot_time)
            ...
            print('C1C0 TURN RIGHT')
            rotate.send_msg(rotate.format_msg(60, 0, 0))
            time.sleep(rot_time)
